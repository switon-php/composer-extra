...
Security fixes are provided for **currently supported release lines** of `switon/composer-extra` (`switon/composer-extra` on Packagist).
...
1. **GitHub private vulnerability reporting (preferred)**  
   [Report a vulnerability](https://github.com/switon-php/composer-extra/security/advisories/new)
